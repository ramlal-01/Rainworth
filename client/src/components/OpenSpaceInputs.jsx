    ...
    <div className="col-span-1 md:col-span-2 space-y-1">
      ...
      <div className="flex flex-col sm:flex-row items-stretch sm:items-center space-y-2 sm:space-y-0 sm:space-x-2">
        <input
          ...
          className="flex-1 w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 transition-colors duration-200 p-2 text-gray-900"
        />
        <input
          type="number"
