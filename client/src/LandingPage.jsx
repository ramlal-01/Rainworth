    ...
    return (
        ...
        <header className="bg-white/80 backdrop-blur-md shadow-sm sticky top-0 z-40 border-b border-gray-200/50">
            ...
            <div className="hidden lg:flex items-center">
                <button onClick={() => {}} className="bg-blue-600 text-white font-semibold py-2 px-5 rounded-full hover:bg-blue-700 transition-all duration-300 transform hover:scale-105 shadow-md">
                Start Assessment
                </button>
            </div>
            ...
            <div className="px-6 pb-4 flex flex-col items-start space-y-4">
                ...
                <button onClick={() => { setIsMenuOpen(false); }} className="w-full bg-blue-600 text-white font-semibold py-3 mt-2 rounded-lg hover:bg-blue-700 transition-all duration-300 shadow-md">
                    Start Assessment
                </button>
            </div>
            </div>
        ...
        <section id="home" className="min-h-screen flex items-center justify-center px-4 relative">
            ...
            <h1 className="text-5xl md:text-7xl font-black mb-6 leading-tight">
                <span className="block text-blue-900">Save Rainwater,</span>
                <span className="block bg-gradient-to-r from-green-500 via-blue-600 to-purple-500 bg-clip-text text-transparent">Raise the Future.</span>
            </h1>
            ...
            <div className="relative inline-block group">
                ...
                <button onClick={() => {}} className="relative bg-gradient-to-r from-blue-600 to-green-500 text-white font-bold py-4 px-8 rounded-full text-lg hover:shadow-2xl transition-all duration-300 transform hover:scale-105">
        ...
        <main className="container mx-auto px-6 py-16 md:py-24 relative z-10">
            ...
            <h2 className="font-extrabold text-4xl md:text-5xl text-blue-900 mb-4">Our Challenge & Solution</h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto mb-12">Rainworth is designed to bridge the gap between the vast potential of rainwater harvesting and public participation by providing a simple, data-driven tool for every citizen.</p>
            <div className="max-w-4xl mx-auto grid md:grid-cols-2 gap-8">
                <div className="bg-white rounded-xl p-8 shadow-lg transition-all duration-300 hover:shadow-2xl hover:-translate-y-2 border-t-4 border-red-500">
                ...
                <div className="bg-white rounded-xl p-8 shadow-lg transition-all duration-300 hover:shadow-2xl hover:-translate-y-2 border-t-4 border-green-500">
                <div className="bg-green-100 w-16 h-16 rounded-full flex items-center justify-center mb-4 mx-auto"><svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-green-600" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 01118 0z" /></svg></div>
            ...
            <div className="mt-12 bg-blue-50/50 p-6 rounded-xl inline-block backdrop-blur-sm">
            ...
            <h2 className="font-extrabold text-4xl md:text-5xl text-blue-900 mb-4">How It Works</h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto mb-12">Get a detailed report in three simple steps.</p>
            <div className="grid md:grid-cols-3 gap-8 relative">
                ...
                { title: "Data Analysis", desc: "Our system analyzes local GIS data, rainfall, and groundwater levels.", icon: <svg className="h-10 w-10 text-green-600" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 7h6m0 10v-3m-3 3h.01M9 17h.01M9 14h.01M12 14h.01M15 11h.01M12 11h.01M9 11h.01M12 8h.01M15 8h.01M15 5h.01M12 5h.01M9 5h.01M4 7h1m16 0h1M4 12h1m16 0h1M4 17h1m16 0h1" /></svg>, color: "green" },
                { title: "Get Report", desc: "Receive a personalized report with recommendations and cost estimates.", icon: <svg className="h-10 w-10 text-purple-600" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V7a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" /></svg>, color: "purple" }
                ].map((step, i) => (
                <div key={i} className="bg-white rounded-xl p-8 shadow-lg flex flex-col items-center transition-all duration-300 hover:shadow-2xl hover:-translate-y-2 relative border-t-4" style={{borderColor: step.color}}>
            ...
            <section id="benefits" className="text-center fade-in">
                <h2 className="font-extrabold text-4xl md:text-5xl text-blue-900 mb-4">What are the Benefits?</h2>
                <p className="text-lg text-gray-600 max-w-3xl mx-auto mb-12">This application empowers individuals and communities with the knowledge to make impactful decisions for a water-secure future.</p>
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                {[
                    { title: "Accurate Information", desc: "Access hyperlocal data on groundwater levels, rainfall patterns, and soil types.", icon: "📊" },
                    { title: "Personalized Suggestions", desc: "Get tailored recommendations for the most suitable recharge structures for your home.", icon: "🎯" },
                    { title: "Cost Estimation", desc: "Receive a clear estimate of the costs and potential long-term benefits of implementation.", icon: "💰" },
                    { title: "Public Awareness", desc: "Understand the importance of water conservation and inspire your community.", icon: "🌍" },
                    { title: "Easy Access", desc: "Our tool will support regional languages to ensure inclusivity for all users.", icon: "🗣️" },
                    { title: "Sustainable Impact", desc: "Directly contribute to sustainable water management and a healthier environment.", icon: "🌱" },
                ].map((benefit, i) => (
                    <div key={i} className="bg-white rounded-xl p-8 shadow-lg transition-all duration-300 hover:shadow-2xl hover:-translate-y-2 flex flex-col items-center text-center">
